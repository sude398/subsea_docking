...
# ─────────────────────────────────────────────
# YENİ: Kamera Cihaz & GStreamer Ayarları
# (camera_usage_example ile uyumlu hale getirildi)
# ─────────────────────────────────────────────
CAMERA_DEVICE = '/dev/video2'   # Alt kamera V4L2 cihaz yolu (integer index yerine)
CAMERA_FLIP = False             # Kamera fiziksel olarak ters monte edildiyse True yapın
GSTREAMER_PORT = 5603           # Yüzey (Monster PC) UDP stream portu (5601=ön, 5602=alt pipeline)
GSTREAMER_TARGET_IP = '10.42.0.1'  # Yüzey bilgisayar IP adresi

# ─────────────────────────────────────────────
# YENİ: CLAHE Görüntü İyileştirme Parametreleri
# (Sualtı kontrast iyileştirmesi — pipeline örneğinden alındı)
# ─────────────────────────────────────────────
